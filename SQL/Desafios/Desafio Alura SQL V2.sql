...
SELECT AVG(valor_nota) FROM tabela_notas WHERE id_disciplina = 2;

SELECT * FROM tabela_alunos WHERE nome_aluno LIKE 'J%';

SELECT * FROM tabela_alunos WHERE data_nacimento_aluno LIKE '%-02-%';

SELECT nome_aluno, DATE(CURRENT_TIMESTAMP) - data_nacimento_aluno FROM tabela_alunos GROUP BY id_aluno;
